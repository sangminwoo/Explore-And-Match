...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory,
        ...
        if self.return_intermediate:
            return torch.stack(intermediate), torch.stack(att_weights)
...
def build_transformer_joint(args):
    return TransformerJoint(
