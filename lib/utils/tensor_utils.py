...
if __name__ == '__main__':
    test_data_list = [[1,2,3], [1,2], [3,4,7,9]]
    print(pad_sequences_1d(test_data_list, dtype=torch.long))

    test_data_3d = [torch.randn(2,3,2), torch.randn(5,3,2), torch.randn(1,3,2), torch.randn(1,3,2)]
    print(pad_sequences_1d(test_data_3d, dtype=torch.float)[0].shape) # padded_seqs 4x5x3x2
    print(pad_sequences_1d(test_data_3d, dtype=torch.float)[1].shape) # mask 4x5

    test_data_list = [[1,2,3], [1,2], [3,4,7,9]]
    print(pad_sequences_1d(test_data_list, dtype=np.float32))

    test_data_3d = [np.random.randn(2,3,4), np.random.randn(5,3,4), np.random.randn(1,3,4)]
    print(pad_sequences_1d(test_data_3d, dtype=np.float32)[0].shape) # padded_seqs 3x5x3x4
    print(pad_sequences_1d(test_data_3d, dtype=np.float32)[1].shape) # mask 3x5
